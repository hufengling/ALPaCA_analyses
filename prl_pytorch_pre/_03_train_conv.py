...
#bsub -q taki_normal -n 21 -J "pretrain[1-10]" bash -c "python /home/fengling/Documents/prl/prl_pytorch/_03_train_conv.py"
import os
...
torch.save(prl_autoencoder.state_dict(), "/home/fengling/Documents/prl/prl_pytorch/cv_models_conv/prl_autoencoder_05_" + str(prl_dl.i) + ".pt")
