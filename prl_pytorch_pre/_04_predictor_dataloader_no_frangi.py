...
images_dir = "/home/fengling/Documents/prl/data/processed/processed_using_all_lynn"
subjects_df = pd.read_csv("/home/fengling/Documents/prl/cv_results/cv_df.csv")
...
transforms = [
    ...
    tio.RandomFlip(),
    tio.RandomGamma(log_gamma = (-0.5, 0.5), exclude = ["prob", "lesion_mask", "lesion_type"])
