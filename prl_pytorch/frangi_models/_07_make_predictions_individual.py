...
prl_autoencoder.load_state_dict(torch.load("/home/fengling/Documents/prl/prl_pytorch/cv_models_frangi/prl_autoencoder_05_" + str(prl_dl.cv_index) + ".pt", 
                                           map_location=torch.device('cpu')))
prl_autoencoder.eval()
prl_autoencoder.to(device)

# Load the state_dict from the checkpoint
prl_autoencoder_joint.load_state_dict(torch.load("/home/fengling/Documents/prl/prl_pytorch/cv_models_frangi/prl_joint_05_" + str(prl_dl.cv_index) + ".pt", 
                                           map_location=torch.device('cpu')))
prl_autoencoder_joint.eval()
prl_autoencoder_joint.to(device)

# Load the state_dict from the checkpoint
prl_predictor.load_state_dict(torch.load("/home/fengling/Documents/prl/prl_pytorch/cv_models_frangi/prl_predictor_05_" + str(prl_dl.cv_index) + ".pt", 
                                           map_location=torch.device('cpu')))
prl_predictor.eval()
...
if not os.path.exists("/home/fengling/Documents/prl/cv_output_frangi/split_" + str(prl_dl.cv_index)):
    os.mkdir("/home/fengling/Documents/prl/cv_output_frangi/split_" + str(prl_dl.cv_index))
    
df.to_csv("/home/fengling/Documents/prl/cv_output_frangi/split_" + str(prl_dl.cv_index) + 
