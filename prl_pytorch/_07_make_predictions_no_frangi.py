#bsub -q taki_normal -J "make_predictions_no_frangi[1-970]" -o ~/Documents/prl/stdout/make_predictions_no_frangi.txt bash -c "python /home/fengling/Documents/prl/prl_pytorch/_07_make_predictions_no_frangi.py"
import os
import torch
...
prl_autoencoder_joint.load_state_dict(torch.load("/home/fengling/Documents/prl/prl_pytorch/models/cv_models/prl_joint_05_" + str(prl_dl.cv_index) + ".pt", 
                                           map_location=torch.device('cpu')))
prl_autoencoder_joint.eval()
prl_autoencoder_joint.to(device)

# Load the state_dict from the checkpoint
prl_predictor.load_state_dict(torch.load("/home/fengling/Documents/prl/prl_pytorch/models/cv_models/prl_predictor_05_" + str(prl_dl.cv_index) + ".pt", 
                                           map_location=torch.device('cpu')))
prl_predictor.eval()
...
df = get_predictions(prl_dl.subject, 100)

if not os.path.exists("/home/fengling/Documents/prl/cv_output/split_" + str(prl_dl.cv_index)):
    os.mkdir("/home/fengling/Documents/prl/cv_output/split_" + str(prl_dl.cv_index))
    
df.to_csv("/home/fengling/Documents/prl/cv_output/split_" + str(prl_dl.cv_index) + 
