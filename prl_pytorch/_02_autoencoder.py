...
class Autoencoder3D(nn.Module):
    def __init__(self):
        ...
        self.encoder = nn.Sequential(
            ...
            nn.Conv3d(32, 128, kernel_size=3, stride=1, padding=1), 
        ...
        self.decoder = nn.Sequential(
            ...
            nn.Upsample(scale_factor=2, mode='nearest'),
            nn.ConvTranspose3d(128, 32, kernel_size=3, stride=1, padding=1),  
            nn.BatchNorm3d(32),
            nn.ReLU(), # 12x12x12x64 -> 24x24x24x16
            nn.ConvTranspose3d(32, 4, kernel_size=3, stride=1, padding=1) # 24x24x24x8 -> 24x24x24x4
        )
