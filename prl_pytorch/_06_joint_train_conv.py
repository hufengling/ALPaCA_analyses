...
#bsub -q taki_normal -n 21 -J "train_predictor[1-10]" bash -c "python /home/fengling/Documents/prl/prl_pytorch/_06_joint_train_conv.py"
import os
...
model_path = "/home/fengling/Documents/prl/prl_pytorch/cv_models_conv/prl_autoencoder_05_" + str(prl_dl.i) + ".pt"
...
torch.save(prl_autoencoder.state_dict(), "/home/fengling/Documents/prl/prl_pytorch/cv_models_conv/prl_joint_05_" + str(prl_dl.i) + ".pt")
torch.save(prl_predictor.state_dict(), "/home/fengling/Documents/prl/prl_pytorch/cv_models_conv/prl_predictor_05_" + str(prl_dl.i) + ".pt")
