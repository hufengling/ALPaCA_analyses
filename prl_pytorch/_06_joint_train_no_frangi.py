...
#bsub -q taki_normal -n 21 -J "train_predictor[1-10]" bash -c "python /home/fengling/Documents/prl/prl_pytorch/_06_joint_train_no_frangi.py"
import os
...
import _05_predictor_no_frangi as prl_pred
...
torch.save(prl_autoencoder.state_dict(), "/home/fengling/Documents/prl/prl_pytorch/cv_models/prl_joint_05_" + str(prl_dl.i) + ".pt")
torch.save(prl_predictor.state_dict(), "/home/fengling/Documents/prl/prl_pytorch/cv_models/prl_predictor_05_" + str(prl_dl.i) + ".pt")
